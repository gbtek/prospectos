...
?><html lang="es">
  ...
  <body>
      ...
      <div class="MainFormModal templatemo-content-widget white-bg">
            <form action="evaluacion.php" class="templatemo-login-form" method="post" enctype="multipart/form-data">
                      ...
                      <tr>
                        <td colspan="3">
                          ...
                          <div class="col-lg-12 form-group">                   
                              <label class="control-label" for="inputNote">Observaciones</label>
                              <textarea class="form-control" name="eval_02" id="eval_02" rows="3" required></textarea>
                              <input type="hidden" name="eval_01" id="eval_01" value="<? print(Encriptar($idprosGet)); ?>">
                          </div>
                          </div>
                        </td>
                      </tr> 
                    <tr>
                      ...
                      <td>
                        <div class="view-img-btn-wrap">
                          <button type="submit" name="aut" value="si" class="btn btn-default boton-autorizado"><i class="fa  fa-check-circle fa-fw"></i>AUTORIZAR</button>
                        </div>
                      </td>
                      <td>
                        <div class="view-img-btn-wrap">
                          <button type="submit" name="rech" value="si" class="btn btn-default boton-rechazado"><i class="fa fa-times-circle fa-fw"></i>RECHAZAR</button>
                        </div>
                      </td>
                      </tr> 
                  </tbody>
